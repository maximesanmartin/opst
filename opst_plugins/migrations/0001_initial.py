...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchBoxPlugin'
        db.create_table('cmsplugin_searchboxplugin', (
        ...
        db.send_create_signal('opst_plugins', ['SearchBoxPlugin'])
        ...
        # Adding model 'NewsFeedPlugin'
        db.create_table('cmsplugin_newsfeedplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('list_max', self.gf('django.db.models.fields.PositiveIntegerField')(default=8)),
        ))
        db.send_create_signal('opst_plugins', ['NewsFeedPlugin'])


    def backwards(self, orm):
        # Deleting model 'SearchBoxPlugin'
        db.delete_table('cmsplugin_searchboxplugin')

        # Deleting model 'NewsFeedEntry'
        db.delete_table('opst_plugins_newsfeedentry')

        # Deleting model 'NewsFeedPlugin'
        db.delete_table('cmsplugin_newsfeedplugin')
    ...
    models = {
        ...
        'opst_plugins.newsfeedplugin': {
            'Meta': {'object_name': 'NewsFeedPlugin', 'db_table': "'cmsplugin_newsfeedplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'list_max': ('django.db.models.fields.PositiveIntegerField', [], {'default': '8'})
        },
        'opst_plugins.searchboxplugin': {
            'Meta': {'object_name': 'SearchBoxPlugin', 'db_table': "'cmsplugin_searchboxplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
